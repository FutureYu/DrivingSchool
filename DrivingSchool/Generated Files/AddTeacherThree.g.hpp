...
void ::DrivingSchool::AddTeacherThree::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
    ...
    _contentLoaded = true;
    ::Windows::Foundation::Uri^ resourceLocator = ref new ::Windows::Foundation::Uri(L"ms-appx:///AddTeacherThree.xaml");
    ::Windows::UI::Xaml::Application::LoadComponent(this, resourceLocator, ::Windows::UI::Xaml::Controls::Primitives::ComponentResourceLocation::Application);
}

void ::DrivingSchool::AddTeacherThree::Connect(int __connectionId, ::Platform::Object^ __target)
{
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::DrivingSchool::AddTeacherThree::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
